  ...
  $.fn.ColorPickerSliders = function(options) {
    ...
    return this.each(function() {
      ...
      function _getControllerHtml() {
        ...
        if (settings.swatches) {
          color_picker_html += '<div class="cp-swatches clearfix"><button type="button" class="add btn btn-light" title="' + settings.titleswatchesadd + '"><span class="fas fa-save"></span></button><button type="button" class="remove btn btn-light" title="' + settings.titleswatchesremove + '"><span class="fas fa-trash-alt"></span></button><button type="button" class="reset btn btn-light" title="' + settings.titleswatchesreset + '"><span class="fas fa-undo-alt"></span></button><ul></ul></div>';
        }
        ...
        if (swatches instanceof Array) {
          ...
          for (var i = 0; i < swatches.length; i++) {
            ...
            if (color.isValid()) {
              ...
              var button = $('<div class="btn btn-light cp-swatch"></div>');
