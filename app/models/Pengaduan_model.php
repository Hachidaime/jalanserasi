...
class Pengaduan_model extends Database
{
    ...
    public function getPengaduanForm()
    {
        ...
        Functions::setDataSession('form', [
            ...
            'no_jalan',
            'Ruas Jalan',
            $this->model('Jalan_model')->getJalanOptions(),
            false,
            false
        ]);
        Functions::setDataSession('form', ['separator']);
        ...
        Functions::setDataSession('form', [
            ...
            false,
            false,
            'Jarak lokasi dari ujung/awal ruas jalan.'
        ]);
        Functions::setDataSession('form', [
            'switch',
            'on_site',
            'on_site',
            'Apakah saat ini Anda berada di lokasi pengaduan?',
            [],
            false,
            false
        ]);
    ...
    public function getPengaduanViewForm()
    {
        ...
        Functions::setDataSession('form', [
            ...
            'jarak',
            'jarak',
            'Jarak lokasi dari ujung/awal ruas jalan (km)'
        ]);
        Functions::setDataSession('form', [
            'plain-text',
            'koordinat',
    ...
    public function getPengaduan()
    {
        ...
        if (!empty($search['search'])) {
            $params['filter'] = "nama LIKE '%{$search['search']}%'";
        }
