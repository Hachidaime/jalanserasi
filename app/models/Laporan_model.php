...
class Laporan_model extends Database
{
    ...
    public function getDd1Thead()
    {
        ...
        Functions::setDataSession('thead', [
            ...
            null,
            'No',
            'data-halign="center" data-rowspan="3"'
        ]);
        Functions::setDataSession('thead', [
            '0',
            null,
        ...
        Functions::setDataSession('thead', [
            '0',
            null,
            'Kecamatan<br>yang<br>dilalui',
            'data-halign="center"  data-rowspan="3"'
        ]);
        Functions::setDataSession('thead', [
            '0',
            null,
            'Panjang<br>Ruas<br>(km)',
            'data-halign="center" data-rowspan="3"'
        ]);
        Functions::setDataSession('thead', [
            '0',
        ...
        Functions::setDataSession('thead', [
            ...
            'data-halign="center" data-colspan="4"'
        ]);
        Functions::setDataSession('thead', [
            '0',
            null,
            'Panjang Tiap Kondisi (km)',
            'data-halign="center" data-colspan="8"'
        ]);
        Functions::setDataSession('thead', [
            '0',
            null,
        ...
        Functions::setDataSession('thead', [
            ...
            null,
            'Baik',
            'data-halign="center" data-colspan="2"'
        ]);
        Functions::setDataSession('thead', [
            '1',
            null,
    ...
    public function getDd2Thead()
    {
        ...
        Functions::setDataSession('thead', [
            ...
            null,
            'Dimensi',
            'data-halign="center" data-colspan="3"'
        ]);
        Functions::setDataSession('thead', [
            '0',
            null,
