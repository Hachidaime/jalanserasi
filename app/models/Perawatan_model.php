<?php
class Perawatan_model extends Database
{
    private $my_tables = [
        'jalan' => 'tperawatan',
        'detail' => 'tdetail_perawatan',
        'koordinat' => 'tkoordinat_perawatan',
        'foto' => 'tfoto_perawatan',
        'panjang' => 'tpanjang_perawatan',
    ];
    ...
    public function prepareSaveJalan()
    {
        ...
        foreach ($_POST as $key => $value) {
            ...
            if (in_array($key, ['panjang', 'lebar_rata', 'segmentasi'])) {
